...
var scriptConfig = {
    ...
    translations: {
        ...
        ro_RO: {
            'Construction Times': 'Timpi de Construcție',
            Help: 'Ajutor',
            ...
            Village: 'Sat',
            Building: 'Clădire',
            'Finish Time': 'Ora Finalizării',
            'Time Left': 'Timp Rămas',
            'On the table are listed only upgrades that finish within an hour.':
                'În tabel sunt listate doar îmbunătățirile care se finalizează într-o oră.',
            'No building upgrades found that finish within an hour!':
                'Nu au fost găsite îmbunătățiri de clădiri care se finalizează într-o oră!',
            Finish: 'Finalizare',
            'Upgrade has finished!': 'Îmbunătățirea s-a finalizat!',
        },
    },
    allowedMarkets: [],
